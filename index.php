	...
	?>
		...
		<!-- Banner -->
			<section id="banner" class="wrapper">
				<div class="container">
				<h2>Agriculture</h2>
				<p>Project By RK University Students</p>
				<br><br>
				<center>
		...
		<!--	<div class="logo">
			...
			<br />
			<p style="font-size:20px;color:white">Project By RK University</p>
			<br />
		</div>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Agriculture<span>Rk University</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">98547657654</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="mailto:ymajithiiay905@gmail.com" style="color:white">rku@rku.com</a></p>
			</div>
		</div>
